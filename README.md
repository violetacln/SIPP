...
A [Working Paper](http://hagstofan.s3.amazonaws.com/media/public/2023/79a217c5-f567-4ddb-bed7-45329a32d531.pdf), entitled "Methodology of population projections based on hierarchical Bayesian models" has been published in the Statistical Series of Statistics Iceland. The most recent progress is described in the presentation for the [Nordic Demography Symposium 2025](https://github.com/violetacln/SIPP/blob/main/sipp_v2025_June.pdf).

Newly added: a [script](https://github.com/violetacln/SIPP/blob/main/sipp_brnn_pub.R) experimenting with Bayesian Regularized Neural Networks for fitting and forecaasting the demographic components, while adding data and model uncertainty and then building stochastic projections.
